...
const items = [
    ...
    { nama: "Busur Panah", hargaJual: 450, hargaBeli: 2200, kategori: 'RARE', tipe: 'senjata', stats: { attack: 20, defense: 5 } },
    { nama: "Martil Perang", hargaJual: 500, hargaBeli: 2400, kategori: 'RARE', tipe: 'senjata', stats: { attack: 30, hp: 15 } },
    
    // --- Senjata Tier 4 (Rare) ---
    { nama: "Pedang Kristal", hargaJual: 800, hargaBeli: 4000, kategori: 'RARE', tipe: 'senjata', stats: { attack: 35, mana: 20 } },
    { nama: "Tongkat Aether", hargaJual: 750, hargaBeli: 3800, kategori: 'RARE', tipe: 'senjata', stats: { attack: 20, mana: 60 } },
    { nama: "Belati Bayangan", hargaJual: 700, hargaBeli: 3600, kategori: 'RARE', tipe: 'senjata', stats: { attack: 28 } },
    { nama: "Busur Legendaris", hargaJual: 900, hargaBeli: 8800, kategori: 'EPIC', tipe: 'senjata', stats: { attack: 28, defense: 8 } },
    { nama: "Kapak Guntur", hargaJual: 1000, hargaBeli: 9600, kategori: 'EPIC', tipe: 'senjata', stats: { attack: 40, hp: 25 } },
    ...
    // --- Helmet Tier 4 ---
    { nama: "Helem Kristal", hargaJual: 800, hargaBeli: 4000, kategori: 'RARE', tipe: 'helem', stats: { hp: 120, defense: 12 } },
    { nama: "Mahkota Aether", hargaJual: 750, hargaBeli: 3800, kategori: 'RARE', tipe: 'helem', stats: { hp: 50, mana: 80, defense: 5 } },
    ...
    // --- Armor Tier 3 ---
    { nama: "Zirah Baja", hargaJual: 600, hargaBeli: 3000, kategori: 'RARE', tipe: 'zirah', stats: { hp: 150, defense: 18 } },
    { nama: "Jubah Sihir", hargaJual: 500, hargaBeli: 2600, kategori: 'RARE', tipe: 'zirah', stats: { hp: 80, defense: 10, mana: 60 } },
    
    // --- Armor Tier 4 ---
    { nama: "Zirah Kristal", hargaJual: 1200, hargaBeli: 12000, kategori: 'EPIC', tipe: 'zirah', stats: { hp: 200, defense: 25 } },
    { nama: "Jubah Aether", hargaJual: 1000, hargaBeli: 10400, kategori: 'EPIC', tipe: 'zirah', stats: { hp: 100, defense: 15, mana: 100 } },
    ...
    // --- Pants Tier 4 ---
    { nama: "Celana Kristal", hargaJual: 800, hargaBeli: 4000, kategori: 'RARE', tipe: 'celana', stats: { hp: 120, defense: 15 } },
    { nama: "Celana Aether", hargaJual: 750, hargaBeli: 3800, kategori: 'RARE', tipe: 'celana', stats: { hp: 60, defense: 8, mana: 60 } },
    ...
    // --- Shoes Tier 4 ---
    { nama: "Sepatu Kristal", hargaJual: 600, hargaBeli: 3000, kategori: 'RARE', tipe: 'sepatu', stats: { hp: 60, defense: 9 } },
    { nama: "Sepatu Aether", hargaJual: 550, hargaBeli: 2800, kategori: 'RARE', tipe: 'sepatu', stats: { hp: 30, defense: 5, mana: 45 } },
    ...
    // --- Accessories Tier 3 ---
    { nama: "Cincin Kristal", hargaJual: 500, hargaBeli: 2400, kategori: 'RARE', tipe: 'aksesoris', stats: { attack: 8, defense: 8 } },
    { nama: "Kalung Baja", hargaJual: 400, hargaBeli: 1000, kategori: 'Peralatan', tipe: 'aksesoris', stats: { hp: 50, defense: 6 } },
    { nama: "Gelang Aether", hargaJual: 450, hargaBeli: 2200, kategori: 'RARE', tipe: 'aksesoris', stats: { hp: 30, mana: 40 } },
    
    // --- Accessories Tier 4 ---
    { nama: "Cincin Legendaris", hargaJual: 1000, hargaBeli: 9600, kategori: 'EPIC', tipe: 'aksesoris', stats: { attack: 12, defense: 12 } },
    { nama: "Kalung Kristal", hargaJual: 800, hargaBeli: 4000, kategori: 'RARE', tipe: 'aksesoris', stats: { hp: 80, defense: 10 } },
    { nama: "Gelang Legendaris", hargaJual: 900, hargaBeli: 8800, kategori: 'EPIC', tipe: 'aksesoris', stats: { hp: 50, mana: 60 } },
    ...
    // === LEGENDARY ITEMS ===
    { nama: "Pedang Legendaris", hargaJual: 5000, hargaBeli: 60000, kategori: 'LEGENDARY', tipe: 'senjata', stats: { attack: 50, mana: 30 } },
    { nama: "Mahkota Legendaris", hargaJual: 4000, hargaBeli: 48000, kategori: 'LEGENDARY', tipe: 'helem', stats: { hp: 200, mana: 100, defense: 15 } },
    { nama: "Zirah Legendaris", hargaJual: 6000, hargaBeli: 72000, kategori: 'LEGENDARY', tipe: 'zirah', stats: { hp: 300, defense: 40 } },
